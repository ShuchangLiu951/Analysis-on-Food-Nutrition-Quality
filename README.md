...
The observed test statistic 0.0 is indicated at the end of graph. p-value(0.0) < 0.0. **We reject the null hypothesis**, the missing rating does depend on the number of ingredients in the recipe
